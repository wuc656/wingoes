...
var errorTestCases = []errorTestCase{
	{hrS_OK, true, true, true},
	{hrE_POINTER, true, false, false},
	{hrE_NOTIMPL, true, true, false},
	{windows.STATUS_ACCESS_DENIED, true, true, true},
	{windows.ERROR_ACCESS_DENIED, true, true, false},
	{Error(hrE_UNEXPECTED), true, true, false},
}
